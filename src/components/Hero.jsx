  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#0F0F0F]">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-5 md:px-12">
        ...
        <button className="rounded-full border border-white/20 px-5 py-2 text-sm font-medium text-white hover:bg-white/10 transition">
          Sou profissional
        </button>
      </nav>
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 pt-16 pb-24 text-center md:pt-24">
        ...
        <div className="mt-14">
          ...
          <div className="grid grid-cols-4 gap-3 md:grid-cols-8">
            {categorias.map(cat => (
              <button
                key={cat.nome}
                onClick={() => setCatSelecionada(cat.nome)}
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <button className="w-full sm:w-auto rounded-full bg-[#FF5C00] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#FF5C00]/30 hover:bg-[#e05200] transition-all">
